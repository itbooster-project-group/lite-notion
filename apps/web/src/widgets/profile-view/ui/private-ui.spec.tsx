...
describe('private profile UI', () => {
  it('показывает имя, email и дату регистрации простым списком', async () => {
    ...
    expect(screen.queryByText('4c8f1b1a-0f6d-4a5e-9f6d-0f6d4a5e9f6d')).not.toBeInTheDocument();
    expect(
      screen.queryByText('Данные текущей учётной записи доступны только для чтения.'),
