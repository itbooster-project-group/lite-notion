# collaboration-presence Specification
...
- **WHEN** authenticated user data отсутствует или не содержит валидных id/name
...
- **GIVEN** users A и B подключены к одному документу
